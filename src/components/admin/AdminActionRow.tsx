...
const actions = [
  {
    ...
    icon: Plus,
    description: "Create SKU + QR instantly",
  },
  {
    label: "Preview QR bank",
    href: "/admin/qr-preview",
    icon: QrCode,
    description: "All QR assets in one grid",
  },
  {
    label: "Export intelligence",
    href: "/admin/export",
    icon: FileDown,
    description: "Download full Excel report",
  },
  {
    label: "Scan analytics",
    href: "/admin/logs",
    icon: Activity,
    description: "Investigate verification feed",
  },
];
...
export function AdminActionRow() {
  return (
    <div className="rounded-3xl border border-white/5 bg-white/[0.02] p-6">
      <p className="text-xs uppercase tracking-[0.5em] text-white/60">Operator tools</p>
